...
def load_audio_library(main_config):
  logger = logging.getLogger(__name__)
  print (f"loading audio library: {main_config}")
  ...
  global effect_second, effect_seconds, effect_minute, effect_minutes
